    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-8">
                        <h2 class="my3">Form Ubah Data Barang</h2>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                        ...
                                        id="namaProduk" name="namaProduk" autofocus
                                        value="<?= (old('namaProduk')) ? old('namaProduk') : $produk['namaProduk'] ?>">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="hargaProduk" name="hargaProduk"
                                        value="<?= (old('hargaProduk')) ? old('hargaProduk') : $produk['hargaProduk'] ?>">
                                </div>
                            </div>
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="stokProduk" name="stokProduk"
                                        value="<?= (old('stokProduk')) ? old('stokProduk') : $produk['stokProduk'] ?>">
                                </div>
                            </div>
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="keteranganProduk"
                                        ...
                                        value="<?= (old('keteranganProduk')) ? old('keteranganProduk') : $produk['keteranganProduk'] ?>">
                                </div>
                            </div>
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        ...
                                        <label class="input-group-text"
                                            for="inputGroupFile01"><?= $produk['gambar']; ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row mt-3">
