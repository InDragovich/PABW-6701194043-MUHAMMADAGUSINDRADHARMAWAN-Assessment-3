        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg "
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" href="/"> <img src="../plugins/images/users/ai.png" alt="user-img"
                                width="36" class="img-circle"><b class="hidden-xs">Agus Indra</b> </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Dashboard Pedagang</h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- row -->
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E"
                                    ...
                                    <h5 class="text-muted vb">Jumlah Barang</h5>
                                </div>
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic"
                                        data-icon="&#xe01b;"></i>
                                    <h5 class="text-muted vb">Jumlah Pesanan</h5>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
